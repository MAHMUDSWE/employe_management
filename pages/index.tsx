      ...
      <main className="py-5">
        ...
        <div className="container mx-auto flex justify-between py-5 border-b">
          <div className="left flex gap-3">
            <button onClick={handler} className="flex bg-indigo-500 text-white px-4 py-2 border rounded-md hover:bg-gray-50 hover:border-indigo500 hover:text-gray-800">
              <span className="px-1"><LiaKeySolid size={23}></LiaKeySolid> </span>Add Employee
            </button>
          </div>
...
function DeleteComponent({ deletehandler, canclehandler }: any) {
  return (
